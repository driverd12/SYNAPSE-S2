...
13. The dashboard at `http://127.0.0.1:8765/?context_id=default` can write, capture conversations, process magic capture drops, ingest, enter/tick/commit Cortex Governor sessions, recall, graph, prune, certify native runtime, sleep, back up, and show context-bus receipt state.
