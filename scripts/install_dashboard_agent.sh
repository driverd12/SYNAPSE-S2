...
NEURONS="${SYNAPSE_S2_NEURONS:-5400}"
...
COMMAND="cd '$ROOT' || exit 2; export MLX_DEVICE='${MLX_DEVICE:-gpu}' SYNAPSE_S2_EMBEDDING_PROVIDER='$EMBEDDING_PROVIDER' SYNAPSE_S2_NEURAL_MODEL='$NEURAL_MODEL' SYNAPSE_S2_NEURAL_CACHE_DIR='$NEURAL_CACHE_DIR' SYNAPSE_S2_NEURAL_LOCAL_FILES_ONLY='$NEURAL_LOCAL_FILES_ONLY' SYNAPSE_S2_DIMENSION='$DIMENSION' SYNAPSE_S2_NEURONS='$NEURONS' SYNAPSE_S2_TOP_K='$TOP_K' SYNAPSE_S2_RECALL_COUNT='$RECALL_COUNT' SYNAPSE_S2_STATE_PATH='$STATE_PATH' SYNAPSE_S2_MEMORY_DB='$MEMORY_DB' SYNAPSE_S2_EXPORT_DIR='$EXPORT_DIR' SYNAPSE_S2_CAPTURE_ROOT='$CAPTURE_ROOT'; exec '$PYTHON' dashboard_server.py --host '$HOST' --port '$PORT' --context '$CONTEXT'"
