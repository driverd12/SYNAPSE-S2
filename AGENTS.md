...
Capture real decisions, corrections, temporal order, blockers, and validation evidence. Do not capture credentials, tokens, private keys, unnecessary personal data, or speculative claims as memory.
